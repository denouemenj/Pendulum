...
def plot_fit(my_func, xdata, ydata, xerror=None, yerror=None, init_guess=None, font_size=14,
    ...
    popt, pcov = optimize.curve_fit(my_func, xdata, ydata, sigma=yerror, p0=init_guess, maxfev=5000)
    ...
    ax1.errorbar(xdata, ydata, yerr=yerror, xerr=xerror, fmt=".", label="measured period", color="blue", lw=1)
    ...
    ax2.errorbar(xdata, residual, yerr=yerror, xerr=xerror, fmt=".", color="blue", lw=1)
